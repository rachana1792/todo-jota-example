...
// step 10 for printing second pyramid, loop the rows, for j comparison initialize i as 1
// step 11: loop the coloumns with value regarding row ie; j>i
// step 12: Concatinate string with " " in j loop 
//step 13: for printing stars insert a loop outside j and inside i. in regards to the value of i as   k < 2 * (r-i) - 1
// step 14: inside k loop concatinate the string value inside the inner loop like, string+="*"
